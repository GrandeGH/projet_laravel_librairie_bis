...
export default function Create({ auth }) {
    ...
    function handleSubmit(e) {
        e.preventDefault();
        post(route('auteurs.store'), { // 'post' est une méthode de useForm pour envoyer les données
            onSuccess: () => {
    ...
    return (
        <AuthenticatedLayout
            user={auth.user}
            header={<h2 className="font-semibold text-xl text-gray-800 dark:text-gray-200 leading-tight">Ajouter un Auteur</h2>}
        >
                    ...
                    <div className="bg-white dark:bg-gray-800 overflow-hidden shadow-sm sm:rounded-lg">
                        <div className="p-6">
                            ...
                            <form onSubmit={handleSubmit}>
                                <div className="mb-3">
                                    <InputLabel htmlFor="nom" value="Nom de l'auteur" />
                                    <TextInput
                                        id="nom"
                                        type="text"
                                        name="nom"
                                ...
                                <div className="d-flex justify-content-end mt-4">
                                    <Link href={route('auteurs.index')} className="btn btn-secondary me-2">
                                        Annuler
                                    </Link>
